...
.___                   __           .__                      __     
|   |  ____    _______/  |_ _____   |  |__  _____     ____  |  | __ 
|   | /    \  /  ___/\   __\\__  \  |  |  \ \__  \  _/ ___\ |  |/ / 
|   ||   |  \ \___ \  |  |   / __ \_|   Y  \ / __ \_\  \___ |    <  
|___||___|  //____  > |__|  (____  /|___|  /(____  / \___  >|__|_ \ 
          \/      \/             \/      \/      \/      \/      \/ 
                                                                            
 

{H}[+] ---------------------------------------------          
{H}[+] E-mail      : tyanbocil7@gmail.com 
{H}[+] Bergabung   : 17 Agustus 1945
{H}[+] Status      : Premium
{H}[+] Kadaluarsa  : Sampai Kiamat
{H}[+] Author     : hi it's me TIAN 
{H}[+] ---------------------------------------------

{H} ---------------------------------------------
{H}          Menu pilihan pilih Satu-satu :
{H} ---------------------------------------------
...
{H}[05]. Check hasil crack

{H}[06]. Bot auto follow
...
{M}[08]. Keluar
 ...
 [3]. USER AGENT - V3
		...
		print(f"""
 [{H}✓{C}] Hasil LIVE disimpan ke: result/{day}.txt
 [{O}X{C}] Hasil CHECKPOINT disimpan ke: result/{day}.txt
 ...
 [{M}!{C}] nyalakan mode pesawat  setiap 2 menit tod
	...
	def crackAPI(self,user,pas,uaAPI):
		...
		sys.stdout.write(f"\r 🌺 [{K}{loop}/{len(internal)}{C}] {H}OK: - {len(success)}{C}  {M}CP: - {len(checkpoint)}{C} "),
		sys.stdout.flush()
		try:
			for pw in pas:
  ...
  {M}╞{C}
  {M}╰{C} Coba lagi semoga beruntung
					""")
